...
Reads DATABASE_URL from the application's .env file via app.config.settings.
Uses SQLAlchemy metadata from all ORM models for autogenerate support.
"""
...
# Load application config (reads .env)
